...
resource "aws_s3_bucket" "identity_activity_center_long_term_storage" {
  bucket = "${var.iac_long_term_bucket_name}-${data.aws_caller_identity.current.account_id}"
...
resource "aws_s3_bucket" "identity_activity_center_transient_storage" {
  bucket = "${var.iac_transient_bucket_name}-${data.aws_caller_identity.current.account_id}"
